...
namespace OCC.Combat
{
    ...
    public static class FireSpellCatalog
    {
        ...
        public static readonly IReadOnlyList<FireSpellDefinition> All = new[]
        {
            ...
            S("F-P-U18","兵装退火",FireSpellRarity.Uncommon,FireSpellGroup.Universal,U,FireDeliveryMode.BodyEnhancement,NW,Now,Cast,1,3,2,0,0,FireTargetKind.Self,FireSelectionShape.Single,1,false,false,new[]{R(FireRuleKind.ClearOneSelfStatus,scope:FireRuleScope.Source)},"cleanse"),
