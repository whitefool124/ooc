...
namespace OCC.Combat
{
    ...
    public static class ItemCatalog
    {
        ...
        public static readonly ItemDefinition AetherCore = new ItemDefinition("aether_core", "以太核心", "任务回收用工业核心。", ItemCategory.Quest, ItemRarity.Rare, width: 2, height: 2, weight: 3, isQuestItem: true, canDiscard: false, iconPath: "Art/FormalResourceIcons12/operational_aether", inventoryArtPath: "Art/FormalInventoryFootprints/aether_core");
        public static readonly ItemDefinition NurseryReturnCore = new ItemDefinition("ACA-EQ-CR04", "苗床回流芯", "本场第一次成功支付魔力施放个人术式后恢复2魔力。", ItemCategory.Armor, ItemRarity.Uncommon, width: 2, height: 2, weight: 1,
            iconPath: "Art/FormalAcademyEquipmentIcons32/aca_eq_cr04", inventoryArtPath: "Art/FormalAcademyEquipmentFootprints/aca_eq_cr04");
        public static readonly ItemDefinition AcademyStorageCore = new ItemDefinition("ACA-EQ-CR01", "学院储能芯", "装备后个人魔力上限+2；换装不免费恢复魔力。", ItemCategory.Armor, ItemRarity.Uncommon, width: 2, height: 2, weight: 1,
            iconPath: "Art/FormalAcademyEquipmentIcons32/aca_eq_cr01", inventoryArtPath: "Art/FormalAcademyEquipmentFootprints/aca_eq_cr01");
        public static readonly IReadOnlyList<ItemDefinition> All = new[] { Medkit, ShieldCell, FirelineScroll, AetherCore, NurseryReturnCore, AcademyStorageCore }
    ...
    public sealed class LootSourceState
    {
        ...
        public ItemInstance ClaimRevealed(string instanceId)
        {
            if (!revealed.Contains(instanceId) || taken.Contains(instanceId)) return null;
            ItemInstance item = contents.First(value => value.InstanceId == instanceId).Clone();
