...
namespace OCC.Combat
{
    ...
    public static class ItemCatalog
    {
        ...
        public static readonly ItemDefinition NurseryReturnCore = new ItemDefinition("ACA-EQ-CR04", "苗床回流芯", "本场第一次成功支付魔力施放个人术式后恢复2魔力。", ItemCategory.Armor, ItemRarity.Uncommon, width: 2, height: 2, weight: 1, iconPath: "Art/FormalIcons32/loot");
        public static readonly ItemDefinition AcademyStorageCore = new ItemDefinition("ACA-EQ-CR01", "学院储能芯", "装备后个人魔力上限+2；换装不免费恢复魔力。", ItemCategory.Armor, ItemRarity.Uncommon, width: 2, height: 2, weight: 1, iconPath: "Art/FormalIcons32/loot");
