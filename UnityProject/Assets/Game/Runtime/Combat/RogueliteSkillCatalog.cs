...
namespace OCC.Combat
{
    ...
    public static class RogueliteSkillCatalog
    {
        ...
        public static readonly IReadOnlyList<SkillDefinition> All = new[]
        {
            ...
            Skill("searing_mark", "灼蚀标记", SkillTargetRule.EnemyUnit, SkillDeliveryMethod.Projectile, 4, 2, 2, CombatFeedbackKind.BreakStance, new[] { SkillEffectDefinition.Damage(2, DamageType.Fire), SkillEffectDefinition.ApplyStatus(StatusType.BreakStance, 1) }),
            Skill("rail_burst", "轨道点射", SkillTargetRule.EnemyUnit, SkillDeliveryMethod.Projectile, 5, 1, 1, CombatFeedbackKind.Attribute, new[] { SkillEffectDefinition.Damage(3, DamageType.Physical), SkillEffectDefinition.ApplyStatus(StatusType.Agility, 1, -1) }),
            ...
            Skill("damping_field", "阻尼场", SkillTargetRule.EnemyUnit, SkillDeliveryMethod.Area, 4, 3, 3, CombatFeedbackKind.Attribute, new[] { SkillEffectDefinition.Damage(1, DamageType.Arcane), SkillEffectDefinition.ApplyStatus(StatusType.Agility, 2, -1) }, new SkillModifierDefinition(SkillModifierType.Radius, 1)),
            Skill("armor_solvent", "护甲溶剂", SkillTargetRule.EnemyUnit, SkillDeliveryMethod.Projectile, 4, 2, 2, CombatFeedbackKind.BreakStance, new[] { SkillEffectDefinition.Damage(1, DamageType.Arcane), SkillEffectDefinition.ApplyStatus(StatusType.BreakStance, 1) }),
            ...
            Skill("overload_needle", "过载针", SkillTargetRule.EnemyUnit, SkillDeliveryMethod.Projectile, 5, 3, 2, CombatFeedbackKind.BreakStance, new[] { SkillEffectDefinition.Damage(5, DamageType.Arcane), SkillEffectDefinition.ApplyStatus(StatusType.BreakStance, 1) }, new SkillModifierDefinition(SkillModifierType.InitiativeDelay, 2)),
