...
namespace OCC.Combat
{
    ...
    public static class ArtifactCatalog
    {
        ...
        public static readonly ArtifactDefinition AegisFold = A("G-T01", "aegis_fold", "折盾匣", ItemRarity.Uncommon, 3, 1, 3,
            ...
            "3 格内自身或友军", "目标护盾 +20", "只能补充护盾，不能治疗或清除异常", "保护自己或救下同伴", "展开折片并压合回路", "青白折面护盾",
        ...
        public static readonly ArtifactDefinition PhaseSpindle = A("G-T02", "phase_spindle", "移相线轴", ItemRarity.Rare, 2, 1, 3,
            ArtifactTargetRule.EmptyCell, ArtifactSelectionShape.Single, "学院定距器旧型", "通用", "1 行动点，消耗 1 次；下一回合延后 4 刻度",
            "3 格内可达空地；重掩体阻挡", "施术者移至目标格", "被束缚时不能使用，也不能落在有人或障碍的格子", "脱离包围、抢占位置", "拉出线轴并踏入闭环", "短程相位轨迹",
        ...
        public static readonly ArtifactDefinition BindingFrame = A("G-T03", "binding_frame", "缚位框", ItemRarity.Uncommon, 2, 2, 3,
            ArtifactTargetRule.Enemy, ArtifactSelectionShape.Single, "边境猎团", "通用", "2 行动点，消耗 1 次", "3 格内可见敌人",
            "目标束缚 1 回合", "束缚只限制移动；目标仍能攻击、施术和使用物品", "拦住对手、集中攻击", "对准四角并扣合", "四角束带收紧",
            AdvancedPools, new[] { E(ArtifactEffectKind.ApplyStatus, duration: 1, status: StatusType.Bound) }, 2, 2, 2);
        public static readonly ArtifactDefinition SurveyLens = A("G-T04", "survey_lens", "显迹测镜", ItemRarity.Common, 4, 1, 4,
            ArtifactTargetRule.AnyCell, ArtifactSelectionShape.Cross, "遗迹勘验行", "通用", "1 行动点，消耗 1 次", "4 格内可见地格及正交邻格",
        ...
        public static readonly ArtifactDefinition FieldSiphon = A("G-T05", "field_siphon", "以太虹吸泵", ItemRarity.Uncommon, 3, 1, 0,
            ArtifactTargetRule.Self, ArtifactSelectionShape.Single, "边境检修工坊", "通用", "1 行动点，消耗 1 次；失去 8 生命", "自身；魔力未满且生命大于 8",
            "个人魔力 +4，随后失去 8 生命且绕过护盾", "生命太低时使用，很可能让自己倒下", "用生命换取魔力", "压泵抽取生命余量", "青色以太回流",
        ...
        public static readonly ArtifactDefinition MendingLattice = A("G-T06", "mending_lattice", "复元编架", ItemRarity.Rare, 2, 1, 3,
            ArtifactTargetRule.AllyOrSelf, ArtifactSelectionShape.Single, "教会救护工坊", "通用", "1 行动点，消耗 1 次；目标失去 12 护盾", "3 格内受伤且至少有 12 护盾的自身或友军",
        ...
        public static readonly ArtifactDefinition CoverStamp = A("G-T07", "cover_stamp", "掩体压模", ItemRarity.Uncommon, 2, 2, 2,
            ArtifactTargetRule.EmptyCell, ArtifactSelectionShape.Single, "城镇守备石工作坊", "通用", "2 行动点，消耗 1 次", "2 格内未占用、有承重表面的空格",
        ...
        public static readonly ArtifactDefinition RelayCompass = A("G-T09", "relay_compass", "导位罗盘", ItemRarity.Uncommon, 3, 1, 4,
            ArtifactTargetRule.AnyUnit, ArtifactSelectionShape.Single, "商路救援队", "通用", "1 行动点，消耗 1 次", "4 格内可见友军或敌人",
        ...
        public static readonly ArtifactDefinition HazardCondenser = A("G-T11", "hazard_condenser", "险地冷凝器", ItemRarity.Common, 4, 1, 3,
            ...
            CommonPools, new[] { E(ArtifactEffectKind.ClearFireground, scope: ArtifactEffectScope.Selection) }, 2, 2, 2);
        public static readonly ArtifactDefinition TurnLedger = A("G-T12", "turn_ledger", "行程簿", ItemRarity.Rare, 2, 1, 0,
            ArtifactTargetRule.Self, ArtifactSelectionShape.Single, "失落人类文明行旅遗物", "通用", "1 行动点，消耗 1 次；你的下一回合延后 8 刻度", "自身",
            "立即获得 2 行动点，本回合实际增加 1 行动点；行动点最多为 3", "你的下一回合会晚 8 刻，敌人可能连续行动", "现在多做一件事，之后晚些行动", "盖印并合上账页", "蓝色刻度前移并延后行动条",
        ...
        public static readonly ArtifactDefinition AnchorBrace = A("G-T13", "anchor_brace", "定锚支架", ItemRarity.Uncommon, 4, 0, 0,
            ...
            "自动抵消一次推或拉", "只防推拉；不能阻止主动移动、交换位置、伤害或异常", "站稳脚跟，防止被推拉", "三足锚爪自动咬合", "土黄色锚定环",
        ...
        public static readonly ArtifactDefinition PrismRegulator = A("G-T14", "prism_regulator", "棱返调节器", ItemRarity.Rare, 2, 1, 0,
            ArtifactTargetRule.Self, ArtifactSelectionShape.Single, "光学师行会", "通用", "1 行动点，消耗 1 次；效果持续到你的下一回合", "自身",
        ...
        public static readonly ArtifactDefinition DecoyLantern = A("G-T15", "decoy_lantern", "诱导灯", ItemRarity.Uncommon, 2, 2, 3,
            ArtifactTargetRule.EmptyCell, ArtifactSelectionShape.Single, "商队驱兽灯改型", "通用", "2 行动点，消耗 1 次", "3 格内可见空格",
            "部署 12 耐久诱导灯，持续到你的下一次行动结束", "灯会占住一格，任何人都能摧毁它；敌人也可能绕开", "引开敌人、分担攻击", "置灯并翻开遮光片", "暖金诱导脉冲",
        ...
        public static readonly ArtifactDefinition ShieldBalancer = A("G-T16", "shield_balancer", "护盾均衡阀", ItemRarity.Uncommon, 3, 1, 3,
            ArtifactTargetRule.AllyOrSelf, ArtifactSelectionShape.Single, "医护护具工坊", "通用", "1 行动点，消耗 1 次", "3 格内护盾值与使用者不同的友军",
            "合并双方护盾并尽量均分；总护盾不变", "护盾多的一方会把一部分分给另一方", "把护盾分给需要的同伴", "连接双阀并平衡读数", "双向青白护盾流",
            AdvancedPools, new[] { E(ArtifactEffectKind.TransferShield) }, 2, 2, 2);
        public static readonly ArtifactDefinition SeismicPlumb = A("G-T17", "seismic_plumb", "震测铅锤", ItemRarity.Rare, 2, 2, 3,
            ArtifactTargetRule.AnyCell, ArtifactSelectionShape.Cross, "失落人类文明测绘遗物", "通用", "2 行动点，消耗 1 次", "3 格内可见地格及正交邻格；范围至少有一个单位",
            "范围内所有单位下一次行动延后 4 刻度", "敌我全部生效", "范围控制与节奏打断", "落锤测震", "同心震测波",
            RarePools, new[] { E(ArtifactEffectKind.DelayInitiative, 4, scope: ArtifactEffectScope.Selection, allies: true) }, 1, 3, 3);
        public static readonly ArtifactDefinition NullVeil = A("G-T18", "null_veil", "静默幕", ItemRarity.Uncommon, 2, 1, 3,
            ArtifactTargetRule.AllyOrSelf, ArtifactSelectionShape.Single, "失落人类文明封存布", "通用", "1 行动点，消耗 1 次；目标失去 8 生命", "3 格内有指定负面状态且生命大于 8 的自身或友军",
            "清除燃烧、迟缓、束缚、破甲与眩目；不清显形", "会直接失去生命；生命太低时不能使用", "五类定向净化", "罩下静默织幕", "暗紫吸收薄幕",
            AdvancedPools, new[] { E(ArtifactEffectKind.ClearNegativeStatuses), E(ArtifactEffectKind.LoseHealth, 8) }, 3, 2, 2);
        public static readonly ArtifactDefinition FortuneSeal = A("G-T19", "fortune_seal", "冒险封签", ItemRarity.Rare, 2, 2, 4,
            ArtifactTargetRule.Enemy, ArtifactSelectionShape.Single, "黑市回收的远古封签", "通用", "2 行动点，消耗 1 次；若未击倒目标，自己失去 12 生命", "4 格内可见敌人；使用者生命大于 12",
            "造成 28 伤害；若目标仍存活，使用者失去 12 生命且绕过护盾", "目标越耐打，你越可能承受反噬", "孤注一掷地结束战斗", "撕开封签并按向目标", "黑金封印断裂",
