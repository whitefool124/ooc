...
namespace OCC.Combat
{
    public sealed class RainLanternCourtRuntime
    {
        ...
        public static readonly IReadOnlyList<GridPosition> WaterCells = Row(2, 3, 3);
        public static readonly IReadOnlyList<GridPosition> LampVineCells = Rectangle(3, 0, 2, 3);
        public static readonly IReadOnlyList<GridPosition> BurnOrder = new[]
        {
            new GridPosition(4, 1), new GridPosition(4, 2), new GridPosition(4, 0)
        };
        public static readonly IReadOnlyList<GridPosition> HoundSearchPerimeter = new[]
        {
            ...
            new GridPosition(4, 4), new GridPosition(5, 3), new GridPosition(5, 2),
            new GridPosition(5, 1), new GridPosition(5, 0)
        };
        public static readonly IReadOnlyList<GridPosition> PyromancerShootingPoints = new[]
        {
            new GridPosition(5, 0), new GridPosition(5, 2), new GridPosition(4, 4)
        };
        public static readonly IReadOnlyDictionary<string, IReadOnlyList<GridPosition>> VerificationRoutes =
            ...
            {
                ["FIRST-B1-ROUTE-VINE"] = new[] { new GridPosition(1, 4), new GridPosition(2, 2), new GridPosition(3, 2), new GridPosition(4, 2), new GridPosition(5, 2), new GridPosition(5, 0) },
                ["FIRST-B1-ROUTE-WATER"] = new[] { new GridPosition(1, 4), new GridPosition(2, 3), new GridPosition(3, 3), new GridPosition(4, 3), new GridPosition(4, 2), new GridPosition(5, 0) },
                ["FIRST-B1-ROUTE-COVER"] = new[] { new GridPosition(1, 4), new GridPosition(1, 2), new GridPosition(3, 2), new GridPosition(5, 2), new GridPosition(5, 0) }
            };
