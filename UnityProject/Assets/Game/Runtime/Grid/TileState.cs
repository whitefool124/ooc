namespace OCC.Combat
{
    ...
    public sealed class TileState
    {
        ...
        public bool IsDestroyed => Durability <= 0 && (Cover != CoverType.None || IsObjective);
        ...
        public TileState Clone() => new TileState { Cover = Cover, Durability = Durability, IsObjective = IsObjective };
    }
}
