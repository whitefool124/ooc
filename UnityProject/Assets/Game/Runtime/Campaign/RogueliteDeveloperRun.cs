...
namespace OCC.Combat
{
    ...
    public static class RogueliteDeveloperCatalog
    {
        ...
        {
            new RogueliteMissionDefinition("dead_signal", "elimination_rail", CombatObjectiveType.Elimination, "解除阻断传讯的考核拦截", "主角失能则任务失败", "盾术生、火矢生、侧锋生、划线教官"),
            new RogueliteMissionDefinition(RainLanternCourtRuntime.LevelId, "elimination_rail", CombatObjectiveType.Elimination,
                "完成雨后灯庭学院实地对抗课程", "主角生命归零按肉鸽战败", "寻迹兽、火矢生"),
            new RogueliteMissionDefinition("factory_breach", "destruction_factory", CombatObjectiveType.Destruction, "处置考核场内的导能柱", "主角失能则任务失败", "盾术生、火矢生、侧锋生、划线教官"),
            new RogueliteMissionDefinition("rail_patrol", "elimination_rail", CombatObjectiveType.Elimination, "完成石路巡回对练", "主角失能则任务失败", "盾术生、火矢生、侧锋生"),
            new RogueliteMissionDefinition("depot_wreck", "elimination_rail", CombatObjectiveType.Elimination, "解除驿站约束考核", "主角失能则任务失败", "寻迹兽、替身偶、拴索助教"),
            new RogueliteMissionDefinition("relay_raid", "destruction_factory", CombatObjectiveType.Destruction, "处置校准场内的导能柱", "主角失能则任务失败", "侧锋生、背弩生、寻迹兽"),
            new RogueliteMissionDefinition("signal_hub", "elimination_rail", CombatObjectiveType.Elimination, "解除传讯石庭权限拦截", "主角失能则任务失败", "补盾助教、提灯巡查、盾术生"),
            new RogueliteMissionDefinition("elite_foundry", "destruction_factory", CombatObjectiveType.Destruction, "摧毁刻阵工坊内的考核导能柱", "主角失能则任务失败", "划线教官、补盾助教、替身偶"),
            new RogueliteMissionDefinition("gatehouse", "elimination_rail", CombatObjectiveType.Elimination, "通过石闸关口考核", "主角失能则任务失败", "盾术生、替身偶、背弩生"),
            new RogueliteMissionDefinition("transmission_tower", "destruction_factory", CombatObjectiveType.Destruction, "处置传讯塔楼内的考核导能柱", "主角失能则任务失败", "火矢生、拴索助教、提灯巡查"),
            new RogueliteMissionDefinition("core_approach", "elimination_rail", CombatObjectiveType.Elimination, "通过塔前高阶考核", "主角失能则任务失败", "划线教官、背弩生、拴索助教"),
            new RogueliteMissionDefinition("relay_event", "elimination_rail", CombatObjectiveType.Elimination, "\u4e2d\u7ee7\u7ad9\u4e8b\u4ef6", "\u65e0\u65f6\u95f4\u538b\u529b\uff0c\u5b8c\u6210\u8c03\u67e5", "\u73af\u5883\u8bb0\u5f55\u4e0e\u5730\u65b9\u9a7b\u5b88"),
            new RogueliteMissionDefinition("core_finale", "elimination_rail", CombatObjectiveType.Elimination, "击败拦在必经之路上的塔之守卫", "主角失能则任务失败", "塔之守卫、划线教官、补盾助教、提灯巡查"),
            new RogueliteMissionDefinition("last_conduit", "elimination_rail", CombatObjectiveType.Elimination, "完成守备考核与故事包", "主角失能则任务失败", "盾术生、火矢生、侧锋生、划线教官"),
