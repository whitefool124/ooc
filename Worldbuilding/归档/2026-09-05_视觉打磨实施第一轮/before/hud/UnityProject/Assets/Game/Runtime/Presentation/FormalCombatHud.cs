...
namespace OCC.Combat.Presentation
{
    ...
    public sealed class FormalCombatHud : MonoBehaviour
    {
        ...
        private void EnsureUi()
        {
            ...
            statusLabel = Label("状态", heroModule.transform, new Vector2(16, -76), new Vector2(226, 40), FormalUiTheme.BodyFontSize, muted, TextAnchor.MiddleLeft);
            actionPointLabel = Label("行动点", heroModule.transform, new Vector2(244, -76), new Vector2(90, 40), FormalUiTheme.BodyFontSize, FormalUiTheme.Cyan, TextAnchor.MiddleRight);
