...
public static class RenderReview
{
    ...
    public static string Run()
    {
        ...
        try
        {
            ...
            int highlighted=((IDictionary)Get(view,"cells")).Keys.Cast<GridPosition>().Count(p=>bootstrap.PresentBattlefieldCell(p).MoveOverlayTexture!=null);
            return highlighted+"|"+(beforePresentation==signature())+"|"+Convert.ToBase64String(pixels.EncodeToPNG());
        }
        finally
        {
