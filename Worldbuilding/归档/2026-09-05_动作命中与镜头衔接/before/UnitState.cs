...
namespace OCC.Combat
{
    public sealed class UnitState
    {
        ...
        {
            UnitState clone = new UnitState(Id, IsHero, Position, Facing) { DisplayName = DisplayName, EnemyArchetypeId = EnemyArchetypeId, Armor = Armor, Shield = Shield, MaxShield = MaxShield, Block = Block, Speed = Speed, MainHand = MainHand, SkillOne = SkillOne, SkillTwo = SkillTwo };
