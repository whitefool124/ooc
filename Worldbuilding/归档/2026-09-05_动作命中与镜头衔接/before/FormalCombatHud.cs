...
namespace OCC.Combat.Presentation
{
    ...
    public sealed class FormalCombatHud : MonoBehaviour
    {
        ...
        private void EnsureUi()
        {
            ...
            decisionLabel = Label("行动决策", selectedModule.transform, new Vector2(16, -40), new Vector2(380, 48), FormalUiTheme.BodyFontSize, muted, TextAnchor.UpperLeft);
        ...
        private FormalTooltipContent BuildActionTooltip(string action)
        {
            ...
            return new FormalTooltipContent(title, body, line);
        }
