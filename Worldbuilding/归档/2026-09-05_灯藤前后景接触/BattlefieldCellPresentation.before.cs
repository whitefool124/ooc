...
namespace OCC.Combat.Presentation
{
    ...
    public sealed class BattlefieldCellPresentation
    {
        ...
        public Facing UnitVisualFacing { get; }
        ...
        public BattlefieldCellPresentation(GridPosition position, Texture2D floorTexture, Rect floorUv,
            ...
            string hoverText, Vector2 unitTravelOffset = default, Facing? unitVisualFacing = null)
        {
            Position = position;
            ...
            UnitVisualFacing = unitVisualFacing ?? unit?.Facing ?? Facing.South;
