...
public static class RenderReview
{
    ...
    public static string Run()
    {
        ...
        try
        {
            ...
            CombatEffectExecutor.Execute(bootstrap.CurrentState,"hero",CombatEffect.Move(new GridPosition(2,2),Facing.East));
            CombatEffectExecutor.Execute(bootstrap.CurrentState,testUnits[0].Id,CombatEffect.Move(new GridPosition(2,3),Facing.South));
            CombatEffectExecutor.Execute(bootstrap.CurrentState,testUnits[1].Id,CombatEffect.Move(new GridPosition(3,2),Facing.West));
            ...
            bootstrap.BattlefieldViewport.Pan(-10000,0);
